...
def get_expected_dict():
    return {
        ...
        'object': {'id': 'https://id.hel.fi/event/linkedevents:test-1234',
                   'location': {'divisions': [{'municipality': None,
                                               'name': {'fi': 'Helsinki',
                                                        'sv': 'Helsingfors'},
                                ...
                                'latitude': 25.08474,
                                'longitude': 60.243496,
                                'nameMap': {'en': 'Kontula comprehensive service '
                                ...
                                'type': 'Place'},
                   'nameMap': {'fi': 'Lörem ipsum dölör sit ämåt'},
                   'tag': [{'id': 'https://api.hel.fi/linkedevents/v1/keyword/yso:p18105/',
                            'nameMap': {'en': 'discussion groups',
                                        'fi': 'keskusteluryhmät',
                   ...
                   'type': 'Event'},
        'published': None,
        'summaryMap': {'en': 'An unnamed organization announced the event Lörem ipsum '
                             'dölör sit ämåt',
